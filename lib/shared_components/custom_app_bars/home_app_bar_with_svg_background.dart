  ...
  return AppBar(
    ...
    flexibleSpace: Stack(
      ...
      children: [
        ...
        SvgPicture.asset(
          Platform.isAndroid
              ? "assets/icons/appbar_background.svg"
              : "assets/icons/appbar_background_ios.svg",
          width: 1.sw,
          fit: BoxFit.fill,
        ),
        Row(
          ...
          children: [
            ...
            if (isShowMyName == true)
              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                SizedBox(height: 4.h),
                CustomText(
                  text: userGeneralData?.name ?? "Our Community",
                  color: Colors.white,
                  size: 22.sp,
