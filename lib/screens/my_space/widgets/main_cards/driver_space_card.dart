...
class DriverSpaceCard extends StatefulWidget {
  final GatePassModel passModel;
  const DriverSpaceCard({super.key, required this.passModel});

  @override
  State<DriverSpaceCard> createState() => _DriverSpaceCardState();
}

class _DriverSpaceCardState extends State<DriverSpaceCard> {
