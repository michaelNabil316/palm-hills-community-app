...
import 'new_pass_calender.dart';

class NewPassDateFromToBottomSheet extends StatelessWidget {
  const NewPassDateFromToBottomSheet({super.key});
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: CustomTextFormField(
                        ...
                        controller: con.newPassStartDateController,
                    ...
                    SizedBox(
                      ...
                      child: CustomTextFormField(
                        label: "End Date",
                        textInputType: TextInputType.name,
                        controller: con.newPassEndDateController,
