...
import 'package:palm_hills/shared_components/custom_app_bars/home_app_bar_with_svg_background.dart';
...
class MyPassScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: homeAppBarNew(context: context, noBackArrow: true),
      body: Column(
